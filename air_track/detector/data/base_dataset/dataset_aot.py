...
from air_track.utils import common_utils, check_and_change_img_size, transform_imgs, check_image_bit_depth, \
    copy_split_data
from air_track.utils.registry import DATASETS


@DATASETS.register(name='DetectDatasetAot')
...
if __name__ == '__main__':
    dataset_yaml = '../../config/dataset_aot.yaml'
    ...
    dataset = DetectDatasetAot(stage=cfg_data['stage_train'], cfg_data=cfg_data)
