...
from air_track.utils import common_utils, check_and_change_img_size, natural_sort_key, \
    from_txt_read_label, copy_split_data, transform_imgs, check_image_bit_depth
from air_track.utils.registry import DATASETS


@DATASETS.register(name='DetectDatasetYoloTxt')
class DetectDatasetYoloTxt(BaseDataset):
    def __init__(self, stage, cfg_data):
        ...
        for part in self.parts:
            ...
            frames = self.load_dataset(part, part_value)
        ...
        if self.train_val_test_scale != 'None' and self.dataset_params['copy_split_data']:
            # 拷贝拆分后的数据到指定目录
        ...
        print(f"{self.stage} dataset loaded: {len(self.frames)} samples")

    def __len__(self):
        return len(self.frames)

    def load_dataset(self, part, part_value):
        """读取对应 self.stage 的数据"""
        # 读取数据
        frames = []
        ...
        img_names = [img_name for img_name in os.listdir(data_dir) if img_name.endswith(self.cfg_data['img_format'])]
        ...
        for i, img_name in enumerate(img_names):
            ...
            label_path = os.path.join(os.path.dirname(os.path.dirname(img_path)), self.cfg_data['label_folder'],
                                      label_name)
            ...
            if os.path.exists(label_path):
                # 读取标签
                label = from_txt_read_label(label_path)
                labels, error = self.process_label(img_path, label)
            else:
                labels, error = [], True
            data = {
                'part': part,
        ...
        # 拆分训练集、验证集、测试集
        frames = self.split_data(frames, shuffle)
        frames = frames[:int(part_value['nums'])]

        # if part == '0611_processed_640_360_11/train':
        #     frames = frames[:160]
        # if part == '0615_bangwan_processed_640_360_11/train':
        #     frames = frames[:300]
        # if part == '0615_processed_640_360_11/train':
        #     frames = frames[:160]
        # if part == '0618_processed_640_360_11/train':
        #     frames = frames[:160]
        # if part == '0702_T18_1_processed_640_360_11/train':
        #     frames = frames[:250]
        # if part == '0702_T18_2_processed_640_360_11/train':
        #     frames = frames[:250]
        # if part == '0715_JD_no_background_processed_640_360_11/train':
        #     frames = frames[:1200]
        # if part == '0715_JD_background/train':
        #     frames = frames[:800]
        # if part == '0715_T18_background/train':
        #     frames = frames[:800]
        # if part == '0715_T18_no_background_processed_640_360_11/train':
        #     frames = frames[:150]
        # if part == '0717_T18_101_processed_640_360_11/train':
        #     frames = frames[:700]
        # if part == '0727_JD_201_processed_640_360_11/train':
        #     frames = frames[:1000]
        # if part == '0727_JD_202_processed_640_360_11/train':
        #     frames = frames[:1200]
        # if part == '0727_T18_101_processed_640_360_11/train':
        #     frames = frames[:1000]
        # if part == '0727_T18_102_processed_640_360_11/train':
        #     frames = frames[:1200]
        # if part == '0807_JD_part_processed_640_360_11/train':
        #     frames = frames[:2000]
        # if part == '0812_FC30_processed_640_360_11/train':
        #     frames = frames[:2500]
        #
        # if part == '0611_processed_640_360_11/val':
        #     frames = frames[:40]
        # if part == '0615_bangwan_processed_640_360_11/val':
        #     frames = frames[:40]
        # if part == '0615_processed_640_360_11/val':
        #     frames = frames[:40]
        # if part == '0618_processed_640_360_11/val':
        #     frames = frames[:40]
        # if part == '0702_T18_1_processed_640_360_11/val':
        #     frames = frames[:40]
        # if part == '0702_T18_2_processed_640_360_11/val':
        #     frames = frames[:40]
        # if part == '0715_JD_no_background_processed_640_360_11/val':
        #     frames = frames[:120]
        # if part == '0715_JD_background/val':
        #     frames = frames[:200]
        # if part == '0715_T18_background/val':
        #     frames = frames[:40]
        # if part == '0715_T18_no_background_processed_640_360_11/val':
        #     frames = frames[:210]
        # if part == '0717_T18_101_processed_640_360_11/val':
        #     frames = frames[:100]
        # if part == '0727_JD_201_processed_640_360_11/val':
        #     frames = frames[:100]
        # if part == '0727_JD_202_processed_640_360_11/val':
        #     frames = frames[:120]
        # if part == '0727_T18_101_processed_640_360_11/val':
        #     frames = frames[:100]
        # if part == '0727_T18_102_processed_640_360_11/val':
        #     frames = frames[:120]
        # if part == '0807_JD_part_processed_640_360_11/val':
        #     frames = frames[:200]
        # if part == '0812_FC30_processed_640_360_11/val':
        #     frames = frames[:250]
    ...
    def process_label(self, img_path, labels):
        ...
        for label in labels:
            ...
            try:
                ...
                print(f"{img_path} 跳过类别: {cls_idx}。{e}")
                error = True
    ...
    def __getitem__(self, idx):
        ...
        cur_label_name = cur_img_name.replace(self.cfg_data['img_format'], self.cfg_data['gt_format'])
        cur_label_path = os.path.join(os.path.dirname(os.path.dirname(cur_img_path)),
                                      self.cfg_data['label_folder'], cur_label_name)
        ...
        if self.input_frames > 1:
            ...
            prev_frames, prev_img_paths = self.get_prev_step_frame(cur_frame, idx, self.frame_step, self.input_frames)
        ...
        res['cur_label_path'] = cur_label_path
...
if __name__ == '__main__':
    # 测试代码
    dataset_yaml = '../../config/dataset_dalachi.yaml'
    train_yaml = '../../config/detect_train_dalachi.yaml'
    ...
    dataset = DetectDatasetYoloTxt(stage=cfg_data['stage_train'], cfg_data=cfg_data)
