...
if __name__ == '__main__':
    ...
    predictor.model_path = '/home/csz_changsha/PycharmProjects/github/zhuang5252/AirTrack_all/AirTrack_aligner_return_tr/model_saved/TrEstimatorTsm/minimum_loss.pt'
    predictor.set_model()
