import os
from air_track.aligner.engine.trainer_return_dx_dy_angle import Trainer
...
if __name__ == "__main__":
    ...
    dataset_yaml = os.path.join(script_dir, 'config/dataset_dabaige.yaml')
