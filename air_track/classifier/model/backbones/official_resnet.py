# -*- coding: utf-8 -*-
# @Author    : 
# @File      : official_resnet.py
# @Created   : 2025/11/28 上午10:57
# @Desc      : official_resnet网络定义
...
def official_resnet(cfg, pretrained=False):
    model_name = cfg['base_model_name'].lower()  # 假设cfg是一个字典，并且包含'model_name'键
    num_classes = cfg['nb_classes']
    input_channel = cfg['input_channel']
    if model_name in ['resnet18', 'resnet34']:
        return ResNet(BasicBlock, resnet_cfg[model_name], num_classes, input_channel)
    elif model_name in ['resnet50', 'resnet101', 'resnet152']:
        return ResNet(Bottleneck, resnet_cfg[model_name], num_classes, input_channel)
    else:
...
if __name__ == '__main__':
    ...
    model = official_resnet(cfg_data['model_params'])
